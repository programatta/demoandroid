...
This document describes the development of a small demo implemented in Go with **Ebiten**, focusing on creation and adaptation for **Android**.

Each step includes technical explanations, code examples, and a specific branch (`step-*`) in the repository to see the state of the project at that point.

|Step|Description|Branch|View|
|----|-----------|------|----|
...
>
> Branches marked with an asterisk (*) indicate that they contain multiple sub-steps.
